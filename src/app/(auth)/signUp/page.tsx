                ...
                <div className="bg-[url('/_Compound.svg')] ">
                    <div className='flex justify-center'>
                        <div className='min-w-72 max-w-md bg-white w-10/12 rounded-3xl border border-[#EFF4FF] py-10 px-5 sm:px-10 mb-20'>
                            ...
                            <div>
                                <input type='text' className='rounded-xl w-full h-12 border border-[#EFF4FF] mb-6 pl-4' placeholder='Email' />
                            </div>
                            <div className='relative'>
                                <input type={eye ? "text" : "password"} className='rounded-xl w-full h-12 border border-[#EFF4FF] mb-8 pl-4' placeholder='Password' />
                                {!eye &&
                            ...
                            <button className='rounded-xl w-full h-12 bg-button/primary border border-[#EFF4FF] mb-8'>
                                <span className='flex justify-center font-medium text-sm text-white' onClick={() => router.push("/signUp/signUpSuccess")}>
                                    Sign Up
                                </span>
                            </button>
