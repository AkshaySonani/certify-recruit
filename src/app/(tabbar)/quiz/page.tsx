...
import QuizResults from '@/Components/LearnAndEarn/QuizResults';
const Page = () => {
  ...
  const [endTime, setEndTime] = usePersistState(30 * 60, 'quiz:endTime');
  ...
  const [answerSheet, setAnswerSheet] = usePersistState([], 'quiz:answerSheet');
  ...
  return (
    <>
      {userDetails?.learn_and_earn?.results === 0 ? (
