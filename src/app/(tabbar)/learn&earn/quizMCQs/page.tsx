  ...
  return (
    <div className="w-10/12 m-auto max-w-7xl">
      <div className="flex justify-between ">
        ...
        <div>
          <p className="text-sm text-meta-purple-1 font-medium">
            {TEXT?.TIME_REMAINING}
          </p>
          <div className="flex">
            <div>
              <div className="flex mt-3 gap-2">
                <div className="w-8 h-12 bg-meta-light-blue-2 rounded-lg text-xl flex justify-center items-center">
                  0
                </div>
                <div className="w-8 h-12 bg-meta-light-blue-2 rounded-lg text-xl flex justify-center items-center">
                  0
              ...
              <div className="text-meta-light-blue-3 text-sm font-medium mt-1">
                {TEXT?.HOURS}
              </div>
            </div>

            <div className="flex mt-3 gap-2">
              <div className="w-8 h-12  text-xl flex justify-center items-center">
                :
              </div>
            </div>
            <div>
      ...
      <div className="flex w-full mt-8 gap-3">
        <div className="w-2/4 border border-meta-light-blue-2 rounded-2xl p-5">
          <div className="flex justify-center ">
            <p className="text-lg font-semibold text-meta-purple">
              {TEXT?.QUIZ_DETAIL}{" "}
            </p>
          </div>
          <div className="flex justify-between mt-6">
            <div className="w-2/3">
              <p className="text-meta-gray-1 text-sm font-medium">
                {TEXT?.NAME}
              </p>
        ...
        <div className="w-2/4 border border-meta-light-blue-2 rounded-2xl p-5">
          ...
          <div className="flex flex-wrap gap-4 mt-5 items-center">
            {["01", "02", "03", "04", "05", "06", "07", "08", "09", "10"].map(
              (list) => {
                return (
                  <div className=" flex items-center w-8 h-8 justify-center rounded-[4px] bg-meta-gray-2 text-center ">
                    <p>{list}</p>
                  </div>
                );
              }
