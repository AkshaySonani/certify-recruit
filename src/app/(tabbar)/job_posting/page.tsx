    ...
    <div>
      ...
      <div className="flex items-center justify-between w-full lg:flex-nowrap flex-wrap">
        ...
        <div className="flex items-center lg:w-1/2 w-full lg:mt-0 mt-3">
          <div className="border-stroke/secondary border-[1px] rounded-lg p-[13px] mr-[13px] w-1/2">
            <Checkbox label={"Yes"} />
          </div>
          <div className="border-stroke/secondary border-[1px] rounded-lg p-[13px] w-1/2">
            <Checkbox label={"No"} />
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between w-full lg:flex-nowrap flex-wrap">
        ...
        <div className="flex items-center lg:w-1/2 w-full lg:mt-0 mt-3 md:flex-nowrap flex-wrap">
          <div className="border-stroke/secondary border-[1px] rounded-lg p-[13px] w-1/3 md:min-w-[126px] min-w-full">
            <Checkbox label={"On-site"} />
          </div>
          <div className="border-stroke/secondary border-[1px] rounded-lg p-[13px] w-1/3 md:mx-[13px] md:min-w-[126px] min-w-full md:my-0 my-2">
      ...
      >
        <button className="bg-stroke/secondary text-base text-text/paragraph font-medium py-[13px] rounded-lg min-w-[200px]">
          Next
        </button>
      </div>
    </div>
