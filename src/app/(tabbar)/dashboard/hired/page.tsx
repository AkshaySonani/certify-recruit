...
const tableData = [
    { name: "Kate Tanner", Designation: "UI/UX Designer", Experience: "6+ years", Date: "16/02/2024", Status: "Hired" },
    { name: "April Curtis", Designation: "UI/UX Designer", Experience: "5.5+ years", Date: "10/02/2024", Status: "Hired" },
    { name: "Sledge Hammer", Designation: "UI/UX Designer", Experience: "5.5+ years", Date: "16/02/2024", Status: "Hired" },
    { name: "B.A. Baracus", Designation: "UI/UX Designer", Experience: "5+ years", Date: "12/02/2024", Status: "Hired" },
    { name: "Mike Torello", Designation: "UI/UX Designer", Experience: "4+ years", Date: "06/02/2024", Status: "Hired" },
    { name: "Dori Doreau", Designation: "UI/UX Designer", Experience: "4+ years", Date: "16/02/2024", Status: "Hired" },
    { name: "Murdock", Designation: "UI/UX Designer", Experience: "6+ years", Date: "15/02/2024", Status: "Hired" },
                        ...
                        {tableData.map((item) => {
                            return (
                                <tr>
                                    ...
                                    <td className="px-6 py-4 text-gray-500">
                                        <div>
                                            <div className="font-medium text-base text-[#EA4335] ">{item.Status}</div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 text-gray-500">
