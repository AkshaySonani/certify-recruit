...
const menu = [{ title: "Candidates Hired" }, { title: "Active Jobs" }, { title: "Total Jobs" }, { title: "Active Jobs" }]
          ...
          return (
            <div className="relative p-5 border border-[#DCE7FF] rounded-2xl w-1/4 ">
              <div className="bg-[#DCE7FF] rounded-lg h-9 w-9 flex justify-center items-center mb-2">
                <Image src={"/sidebarIcon/jobPosting.svg"} alt="Icon" width={19} height={19} />
              </div>
              ...
              <Image src={"/dashboard/MaskGroup.svg"} className="absolute right-0 top-6" alt="Icon" width={61} height={93} />
            </div>
          )
        })}
      </div>
            ...
            <div className="flex">
              ...
              <div className="">
                <p className="text-text/secondary font-semibold text-xl">
                  ...
                  <p className="text-text/paragraph font-medium text-base">Surat, Gujrat, India.</p>
                </p>
              </div>
